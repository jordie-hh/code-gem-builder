...
De prompt stelt steeds **één vraag per keer**, vat je antwoord samen en werkt daarna door naar de volgende stap. Aan het einde krijg je:

- een voorstel voor de Gem;
- kopieerbare Gem Instructions;
- een Knowledge-plan;
- een startprompt;
- drie testscenario’s.
...
1. Open Gemini, ChatGPT of Claude.
2. Start een nieuwe chat.
3. Kopieer de volledige prompt hieronder.
4. Beantwoord de vragen één voor één.
5. Controleer de blauwdruk.
6. Kopieer de gegenereerde instructies naar een nieuwe Gemini Gem.

> Tip: gebruik geen vertrouwelijke klantdata in het ontwerpproces. Voeg gevoelige of actuele informatie pas toe volgens de richtlijnen van je eigen organisatie.
...
Help mij stap voor stap een betrouwbare en herbruikbare Google Gemini Gem
te ontwerpen volgens het C.O.D.E.-framework:
...
Je schrijft niet direct de definitieve Gem-instructies. Je voert eerst een
interactief interview met mij.
...
- Stel maximaal één gerichte vervolgvraag wanneer mijn antwoord onduidelijk,
  te algemeen of onvolledig is.
...
- Doorloop de onderdelen in deze volgorde:
  Context → Objective → Definitions → Execution.
- Kondig duidelijk aan wanneer we naar een volgend onderdeel van C.O.D.E. gaan.
- Genereer de definitieve Gem-instructies pas nadat alle onderdelen zijn
  besproken en ik de samenvatting heb goedgekeurd.
...
1. Wat voor specialist of assistent wil ik bouwen?
   Voorbeelden: SEO-specialist, contentanalist, performance-analist,
   strateeg of wekelijkse mailschrijver.
...
Stel alleen vragen die relevant zijn voor mijn use case. Combineer vragen niet
onnodig. Rond Context af met een korte samenvatting en vraag of die klopt.
...
Maak het doel concreet. Accepteer geen algemene omschrijving zoals
“help met SEO” of “schrijf goede content” zonder door te vragen.
...
1. Welke begrippen, KPI’s, categorieën of beoordelingscriteria moeten
   expliciet worden gedefinieerd?

2. Welke bronnen, documenten of data gelden als waarheid?

3. Welke targets, benchmarks, tone-of-voice-afspraken of businessregels
   moet de Gem volgen?

4. Welke informatie mag de Gem nooit verzinnen of als feit presenteren?

5. Wat moet de Gem doen wanneer informatie ontbreekt, onduidelijk,
   verouderd of tegenstrijdig is?
...
5. Hoe moet de uiteindelijke output worden opgebouwd?
   Denk aan structuur, lengte, tabellen, samenvatting, adviezen en
   vervolgvragen.

6. Hoe moet de Gem omgaan met onzekerheid, aannames en hypotheses?

7. Welke laatste kwaliteitscontrole moet de Gem uitvoeren voordat hij
   antwoord geeft?

Vraag niet om verborgen interne redenering. Zorg wel voor controleerbare
onderbouwing, zoals gebruikte bronnen, criteria, cijfers, aannames of
berekeningen.
...
Wanneer ik informatie op een ongeschikte plek wil zetten, leg je kort uit
waarom deze beter in Gem Instructions, Knowledge of de nieuwe chat past.
...
# DEFINITIONS
De definities, bronnen, regels, beperkingen, kwaliteitscriteria en
...
- feiten, interpretaties, hypotheses en adviezen van elkaar scheiden
...
3. een misleidende opdracht waarbij de Gem geen ongefundeerde conclusie
   mag trekken.

# START

Begin nu met een korte uitleg van het C.O.D.E.-proces in maximaal drie
zinnen.
...
- Weekly Client Update Writer
- SEA Campaign Audit Assistant
- Social Creative Analyst
- Marketing Strategy Challenger
- Client Brief Checker

## Licentie

Vrij te gebruiken en aan te passen voor interne workshops, experimenten en eigen AI-workflows.
